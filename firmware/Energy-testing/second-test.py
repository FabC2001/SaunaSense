...
# === Main Loop ===
last_update_time = 0  # For 1Hz logic

while True:
    now = time.monotonic()

    # --- Stopwatch Button Handling (run every loop) ---
    ...
    # --- Rotary Encoder Movement (run every loop) ---
    ...
    # --- Rotary Encoder Button Press (run every loop) ---
    ...
    # === 1 Hz Section: Sensor, LEDs, Display, State ===
    ...
    time.sleep(0.05)  # Faster polling for encoder/buttons, slower overall CPU usage